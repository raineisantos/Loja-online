...
if ($_FILES["anexo"]["error"] > 0)
{
 ...
 $data_envio = date("d/m/Y");
  ...
  $sql="insert into olfactive_produtos (nome,preco,quantidade,imposto,peso,largura,altura,status,categoria,nome_arquivo,descricao,anexo_ida,data_envio,destaque) values 
('$nome','$preco','$quantidade','$imposto','$peso','$largura','$altura','$status','$categoria','$nome_arquivo','$descricao','$arquivo_nome','$data_envio','$destaque')";
