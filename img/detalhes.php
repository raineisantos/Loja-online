...
<div id="container">
	...
	<div class="header-main">
		...
		<div class="login-block">
			<span class="account"><a href="#" class="account">Sign In</a></span> <span class="cart"><a href="cart.php" class="cart">My Cart (0)</a></span>
		</div>
	</div>
	...
	<div id="navigation">
		...
		<div class="navigation-inner">
			...
			<ul class="sf-menu">
				<li class="nav-item"><a href="#">Pages</a>
					<ul>
						<li class="sfish-navgiation-item">
							<a href="price_compare.php">Price Compare Table</a>
						</li>
						<li class="sfish-navgiation-item">
				...
				<li class="nav-item"><a href="grid.php">Online Store</a>
					<ul>
						<li class="sfish-navgiation-item">
							<a href="grid.php">Product Listing as Grid</a>
						</li>
						<li class="sfish-navgiation-item">
							<a href="list.php">Product Listing as List</a>
						</li>
						<li class="sfish-navgiation-item last">
							<a href="detalhes.php">Product Details</a>
						</li>
					</ul>	
				</li>
		...
		<div class="content-inner">
			...
			<div class="breadcrumbs">
				<ul>
					...
					<li><a href="grid.php">Fragrance</a></li>
      ...
      ?>					
				...
				<div class="featured-product">
					<div class="featured-product-item">
						<a href="#" class="float-left"><img src="<?=$anexo_ida;?>" border="0" /></a>
				...
				<div class="detail-item">
						...
						<div class="product-gallery float-left">
							...
							<div class="panel">	
								...
								<ul id="images">
									<li><a href="images/product1.jpg"><img src="<?=$anexo_ida;?>" title="Home made" /></a></li>
...
<table width="329" border="2" align="center"> 
<form method="POST" action="cart.php">  
<tr align="left">

</tr>
<tr>
<td width="122"><h5>Nome</h5></td>
<td width="151"><input type="text" name="nome" value="<?php echo $nome ?>"
readonly="readonly"></td>
</tr>
<tr>
<td><h5>Valor</h5></td>
<td><input type="text" name="preco" value="<?php echo $preco ?>"
readonly="readonly"></td>
</tr>
<tr>
<td><h5>Descrição</h5></td>
<td><input type="text" name="descricao" value="<?php echo $descricao ?>"
readonly="readonly"></td>
</tr>

<td><h5>Quantidade de itens:</h5></td>
<td><input type="text" name="qtditem" value="1"></td>
</tr><tr align="center">
